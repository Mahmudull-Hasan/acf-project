...
<html lang="en">
   <head>
      <title>Accounting - Free Bootstrap Template by Colorlib</title>
      <meta charset="utf-8">
                            ...
                            <div class="col-md-6 d-flex align-items-center">
                                <p class="mb-0 phone pl-md-2">
                                    ...
                                    <?php 
                                        ...
                                        if($header_email){
                                    ?>
                                        <a href="mailto:<?php echo $header_email; ?>" class="mr-2"><span class="fa fa-paper-plane mr-1"></span> <?php echo $header_email; ?></a>
                                    <?php
                                        }
